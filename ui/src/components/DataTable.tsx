...
export function DataTable({ events, selectedColumns, selectedRowId, selectedCellId, onJsonCellToggle, onReorderColumns, onRowClick }: DataTableProps) {
  ...
  useEffect(() => {
    if (!initialSortSet && selectedColumns.includes('collector_tstamp')) {
  ...
  const columns = useMemo(() => {
    return generateColumns(selectedColumns, selectedCellId, onJsonCellToggle, onReorderColumns);
