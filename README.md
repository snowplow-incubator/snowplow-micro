...
docker run \
  ...
  -p 9090:9090 \
  snowplow/snowplow-micro:1.2.0-rc1 \
...
```bash
java -jar snowplow-micro-1.2.0-rc1.jar --collector-config example/micro.conf --iglu example/iglu.json
```
...
```bash
# Unix
java -cp snowplow-micro-1.2.0-rc1.jar:example com.snowplowanalytics.snowplow.micro.Main --collector-config example/micro.conf --iglu example/iglu.json
# Windows
java -cp snowplow-micro-1.2.0-rc1.jar;example com.snowplowanalytics.snowplow.micro.Main --collector-config example/micro.conf --iglu example/iglu.json
```
